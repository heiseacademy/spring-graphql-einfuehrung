...
public class PublyGraphQLController {
  ...
  @QueryMapping
  public StoryPage stories(@Argument LocalDateTime newerThan, @Argument Optional<Integer> page, @Argument Optional<Integer> size) {
    Pageable pageable = PageRequest.of(
      page.orElse(0),
      size.orElse(10),
    ...
    Page<Story> result = storyRepository.findAllByCreatedAtGreaterThan(newerThan, pageable);
