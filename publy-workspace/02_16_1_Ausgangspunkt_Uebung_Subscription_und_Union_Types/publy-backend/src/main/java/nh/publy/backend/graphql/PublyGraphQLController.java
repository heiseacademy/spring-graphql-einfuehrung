...
public class PublyGraphQLController {
  ...
  public PublyGraphQLController(StoryRepository storyRepository, MarkdownService markdownService, MemberRepository memberRepository, PublyDomainService publyDomainService, CommentRepository commentRepository, CommentEventPublisher commentEventPublisher, ReactionRepository reactionRepository) {
